package com.kratiukkarol.shoppingBackend.test;
...
import com.kratiukkarol.shoppingBackend.dao.UserDAO;
...
public class UserTestCase {
	...
	public static void iniy() {
		...
		context.scan("com.kratiukkarol.shoppingBackend");
		context.refresh();
	...
	*/
	...
	public void testUpdateCart() {
		...
		user = userDAO.getByEmail("rg@gmail.com");
	...
	*/
	...
	public void testGetAddresses() {
		...
		assertEquals("Failed to fetch the list of billing address and size does not match!", "Mumbai", userDAO.getBillingAddress(user).getCity());
	}
}
